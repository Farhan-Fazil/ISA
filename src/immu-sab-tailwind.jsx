...
export default function App() {
  ...
  /* ── NAV ──────────────────────────────────────────── */
  return (
    <div className="min-h-screen" style={{ fontFamily: "var(--cormorant)", background: "#fffdf7", color: "#1c1208" }}>
      <FontLink />

      <nav className={`fixed top-0 left-0 right-0 z-50 px-6 md:px-10 transition-all duration-300 ${scrolled ? "bg-green-950 shadow-2xl" : "bg-transparent"}`}>
        <div className="max-w-6xl mx-auto flex items-center justify-between h-16 md:h-20">
          ...
          <div className="cursor-pointer flex flex-col leading-none" onClick={() => go("home")}>
            <span className="font-playfair text-base md:text-lg font-bold text-yellow-300 tracking-wide" style={{ fontFamily: "var(--playfair)" }}>
              Immu Sab
            </span>
          ...
          <ul className="hidden md:flex items-center gap-8 list-none">
            {[["home","Home"],["about","About"],["booking","Online Booking"],["contact","Contact"]].map(([p,label]) => (
              <li key={p}>
                <button onClick={() => go(p)}
                  className={`nav-link font-crimson text-xs tracking-widest uppercase text-amber-50 hover:text-yellow-300 transition-colors bg-transparent border-none cursor-pointer ${page===p?"active text-yellow-300":""}`}
                  style={{ fontFamily: "var(--crimson)", letterSpacing: "0.2em" }}>
                  {label}
                </button>
              </li>
      ...
      {page === "home" && (
        <>
          {/* Hero */}
          <section className="min-h-screen relative flex items-center overflow-hidden" style={{ background: "#1a3020" }}>
            {/* bg glow */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 pt-28 pb-24 w-full">
              ...
              {/* Title */}
              <h1 className="font-playfair leading-tight mb-5" style={{ fontFamily: "var(--playfair)", fontSize: "clamp(42px,6vw,82px)", color: "#faf4e8", fontWeight: 400 }}>
              ...
              <p className="font-cormorant font-light italic mb-10 max-w-lg leading-relaxed" style={{ fontFamily: "var(--cormorant)", fontSize: "clamp(17px,2.2vw,22px)", color: "#a8c5a0" }}>
              ...
              <div className="flex flex-wrap gap-4 mb-14">
                ...
                <button onClick={() => go("about")}
                  className="font-crimson text-xs tracking-widest uppercase px-9 py-4 border cursor-pointer transition-all duration-200 hover:text-yellow-300 bg-transparent"
      ...
      {page === "about" && (
        <div className="pt-16 md:pt-20">
          {/* Hero */}
          <section className="py-24 px-6 md:px-10 text-center relative overflow-hidden" style={{ background: "#1a3020" }}>
